...
class Pacientes extends React.Component {
    ...
    carregarMedicos = () => {
        ...
        medicoService.getMedicos().then(resposta => {
            this.setState({medicos: resposta.data ,aguardandoDados: false});
        });
    }
    nomeMedico(medico_id){
        for(var i=0; i<this.state.medicos.length; i++) {
            if (medico_id === this.state.medicos[i]){
                return this.state.medicos[i].user_nome;
            }
        }
    }
                                                ...
                                                {this.state.pacientes.map(
                                                    (paciente, index) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td>
                                                                {
                                                                    this.nomeMedico(paciente.medico_id) 
                                                                }
                                                            </td>
                                                            <td>
                                                                <Row><Col><Button
                                                                ...
                                                                </Col><ModalPacienteEditar
                                                                  //  ref={this.pacienteDoencas}
                                                                    isModalAberto={
                                                                        this.state.abrirModalDoencas
                                                                    }
                                                                    paciente={paciente}
                                                                ></ModalPacienteEditar><Col></Col></Row>
